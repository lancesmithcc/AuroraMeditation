        ...
        if (script) {
          ...
          if (audioArrayBuffer && currentAudioContext) {
            ...
            sendToWebhook(
              ...
              analysisParams.meditationTheme, 
              analysisParams.suggestedVoiceProfile,
              currentAnalysisParamsRef.current, // Pass analysis params
              currentAudioContext,             // Pass audio context
              renderFullAudioMix,              // Pass render function
              audioBufferToMp3                 // Pass MP3 encode function
            )
